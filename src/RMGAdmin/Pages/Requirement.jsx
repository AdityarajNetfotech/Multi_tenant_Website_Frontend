...
export default function Requirement() {
    ...
    const jobs = [
        { id: 1, jobId: '#225248', title: 'UI/UX Designer', deadline: '1/09/2025', status: 'Closed' },
        { id: 2, jobId: '#225249', title: 'Frontend Developer', deadline: '5/09/2025', status: 'Open' },
        { id: 3, jobId: '#225250', title: 'Backend Engineer', deadline: '10/09/2025', status: 'Expired' },
        { id: 4, jobId: '#225251', title: 'Project Manager', deadline: '12/09/2025', status: 'Open' },
        { id: 5, jobId: '#225252', title: 'QA Tester', deadline: '15/09/2025', status: 'Closed' },
        { id: 6, jobId: '#225251', title: 'Project Manager', deadline: '12/09/2025', status: 'Open' },
        { id: 7, jobId: '#225252', title: 'QA Tester', deadline: '15/09/2025', status: 'Closed' },
    ];
