...
export default function UnfilteredCandidate() {
    return (
        <div className="fixed inset-0 bg-black/40 backdrop-blur-sm flex items-center justify-center p-4 z-50">
            <div className="bg-white w-full max-w-3xl rounded-xl shadow-lg overflow-y-auto max-h-[90vh] p-6 relative border border-gray-200">
                <button className="absolute top-3 right-4 text-gray-500 hover:text-gray-700 text-xl font-semibold">
                    ×
                </button>
                ...
                <div className="mb-3 text-sm text-gray-700">
                    <span className="font-semibold">Email :</span> trinadas01@gmail.com
                </div>

                <div className="mb-4 text-sm text-gray-700">
                    <span className="font-semibold">Skills :</span> Wireframe,
                    Prototyping, User Research, userflow, communication, leadership
                </div>
