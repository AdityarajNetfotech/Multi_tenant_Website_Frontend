...
function CreateJD() {
        ...
        try {
            ...
            if (generatedJD) {
                ...
                if (generatedJD.responsibilities && generatedJD.responsibilities.length > 0) {
                    jdContent += `\n📌 Responsibilities:\n`;
                    generatedJD.responsibilities.forEach((item, index) => {
                        jdContent += `  • ${item}\n`;
                    });
                }
                ...
                if (generatedJD.requirements && generatedJD.requirements.length > 0) {
                    jdContent += `\n📌 Requirements:\n`;
                    generatedJD.requirements.forEach((item, index) => {
                        jdContent += `  • ${item}\n`;
                    });
                }
                ...
                if (generatedJD.benefits && generatedJD.benefits.length > 0) {
                    jdContent += `\n📌 Benefits:\n`;
                    generatedJD.benefits.forEach((item, index) => {
                        jdContent += `  • ${item}\n`;
                    });
                }
            ...
            const fullCopyText = `${jdUrl}${jdContent}`;
    ...
    const handleShareLinkClick = () => {
        if (generatedJD && jdUrl) {
            ...
            alert('Please create a JD first before sharing');
        }
    };
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center">
                    ...
                    <div className="relative z-10 bg-white rounded-2xl shadow-xl p-6 w-full max-w-md mx-4">
                        ...
                        <p className="text-sm text-center text-gray-500 mb-6">
                            Copy the link below or share directly to social platforms.
                        </p>
                        ...
                        <div className="flex items-center justify-center gap-3 flex-wrap">
                            <a
                                href={`https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent(jdUrl)}`}
                                target="_blank"
                            ...
                            <a
                                href={`https://api.whatsapp.com/send?text=${encodeURIComponent(shareText + ' ' + jdUrl)}`}
                                target="_blank"
                                rel="noopener noreferrer"
                            ...
                            <a
                                href={`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(jdUrl)}`}
                                target="_blank"
                                rel="noopener noreferrer"
                            ...
                            <a
                                ...
                                onClick={(e) => {
                                    e.preventDefault();
                                    navigator.clipboard.writeText(jdUrl);
                            ...
                            <a
                                ...
                                onClick={(e) => {
                                    e.preventDefault();
                                    navigator.clipboard.writeText(jdUrl);
                                    alert('Link copied! You can now paste it on Naukri.');
                            ...
                            <a
                                ...
                                onClick={(e) => {
                                    e.preventDefault();
                                    navigator.clipboard.writeText(jdUrl);
                                    alert('Link copied! You can now paste it on Indeed.');
                            ...
                            <a
                                href={`mailto:?subject=${encodeURIComponent('Job Opportunity')}&body=${encodeURIComponent(shareText + '\n\n' + jdUrl)}`}
                    ...
                    <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6 mb-6">
                        ...
                        <div className="flex justify-center gap-4 mt-8">
                            ...
                            <button
                                ...
                                className='px-12 py-3 bg-black text-white rounded-xl font-medium 
                                    transition-colors shadow-sm hover:bg-gray-800'
                            >
                                Share Link
                            </button>
                        </div>
